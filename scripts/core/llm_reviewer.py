...
def _build_calibration_samples() -> list[dict]:
    ...
    augmentations = [
        ...
        ("Strong Accept", "CausalForest", "ml", "We develop causal forest for heterogeneous treatment effects in finance. 50,000 firm-year observations. ESG disclosure requirements on firm value across subpopulations. Wager & Athey (2018) causal forest. Large-cap firms benefit 3.2x more than small-cap. Lee (2018) bounds validate CATE monotonicity. MSE=0.0031, 65% better than linear DID (MSE=0.0089). Asymptotic normality of CATE with high-dimensional controls. R and Python at github.com/author/causal-forest-finance. (DOI placeholder removed 2026-06-27; reviewers must supply real DOI at submission)"),
