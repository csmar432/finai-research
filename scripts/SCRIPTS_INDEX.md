...
| 分类 | 数量 | 说明 |
|------|------|------|
| 🚀 Entry Points (`scripts/*.py`) | 102 | 顶级入口脚本（含 CLI） |
...
| 🧪 Tests (`tests/`) | 408 | 测试文件 |
| 🔌 MCP Servers (`mcp_servers/user_*/`) | 43 | MCP 数据源 |
| **合计（仅 Python 文件）** | **674** | 不含 MCP / docs / tests fixtures |
...
*本索引由 `scripts/SCRIPTS_INDEX.md` 维护，最后更新: 2026-07-12（自动对账）
