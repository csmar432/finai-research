...
> **重要说明**：43个MCP目录中，约15个完全免费（无需API Key），其余需要付费/机构账号。
...
- LaTeX 输出（49种期刊格式（EN/ZH 44种 + JP/DE 5种），EN/ZH: 经济研究/金融研究/JF/JFE/RFS 等，JP: JPE/RES/JoMa 等，DE: ZWiSt/JNS 等）
