...
> **Real recording** of `python3 scripts/cli.py health` followed by
> `python3 scripts/count_assets.py`. Captured with
> [asciinema](https://asciinema.org/) + [agg](https://github.com/asciinema/agg)
> (100×30 terminal, ~6 sec, 60 KB). Source cast: `.github/demo/demo.cast`.
