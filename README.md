...
![Quick Demo v2 — Full Pipeline](.github/demo/demo_full_pipeline.gif)
...
>
> **v2 (Full Pipeline)** — health + count_assets + version + PyPI inspect,
> 800×600, ~6.4 s, 60 KB. Generated by `scripts/demo/render_demo_gif.py`.
