# REFINED_DESIGN.md — ESG and Financing Constraints
...
2. `python scripts/research_framework/pipeline.py --mode data --topic "ESG and Financing Constraints"`
3. `python scripts/research_framework/pipeline.py --mode analysis --topic "ESG and Financing Constraints"`
4. `python scripts/agent_pipeline.py --topic "ESG and Financing Constraints" --venue 经济研究 --language zh`
