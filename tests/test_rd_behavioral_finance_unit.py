"""Unit tests for scripts.research_directions.behavioral_finance module."""
...
def MODULE_ABBREV():
    ...
    from scripts.research_directions import behavioral_finance as m
...
def test_module_imports(MODULE_ABBREV):
    ...
    assert hasattr(MODULE_ABBREV, "BehavioralFinanceDirection")
...
def test_direction_class_exists(MODULE_ABBREV):
    cls = MODULE_ABBREV.BehavioralFinanceDirection
...
def test_direction_slug_registered(MODULE_ABBREV):
    ...
    assert "behavioral_finance" in all_dirs
