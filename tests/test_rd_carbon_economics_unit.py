"""Unit tests for scripts.research_directions.carbon_economics module."""
...
def MODULE_ABBREV():
    ...
    from scripts.research_directions import carbon_economics as m
...
def test_module_imports(MODULE_ABBREV):
    ...
    assert hasattr(MODULE_ABBREV, "CarbonEconomicsDirection")
...
def test_direction_class_exists(MODULE_ABBREV):
    cls = MODULE_ABBREV.CarbonEconomicsDirection
...
def test_direction_slug_registered(MODULE_ABBREV):
    ...
    assert "carbon_economics" in all_dirs
