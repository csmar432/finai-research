"""Unit tests for scripts.research_directions.macro_finance module."""
...
def MODULE_ABBREV():
    ...
    from scripts.research_directions import macro_finance as m
...
def test_module_imports(MODULE_ABBREV):
    ...
    assert hasattr(MODULE_ABBREV, "MacroFinanceDirection")
...
def test_direction_class_exists(MODULE_ABBREV):
    cls = MODULE_ABBREV.MacroFinanceDirection
...
def test_direction_slug_registered(MODULE_ABBREV):
    ...
    assert "macro_finance" in all_dirs
