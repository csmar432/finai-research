"""tests/test_research_international_finance_deep.py — Deep execution tests for research_directions.international_finance.
...
try:
    import scripts.research_directions.international_finance as m
...
class TestValidate:
    def test_validate_empty(self):
        try:
            d = m.InternationalFinanceDirection()
            r = d.validate({})
