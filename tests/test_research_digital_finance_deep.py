"""tests/test_research_digital_finance_deep.py — Deep execution tests for research_directions.digital_finance.
...
try:
    import scripts.research_directions.digital_finance as m
