"""Unit tests for scripts.research_directions.fintech_innovation module."""
...
def MODULE_ABBREV():
    ...
    from scripts.research_directions import fintech_innovation as m
...
def test_module_imports(MODULE_ABBREV):
    ...
    assert hasattr(MODULE_ABBREV, "FintechInnovationDirection")
...
def test_direction_class_exists(MODULE_ABBREV):
    cls = MODULE_ABBREV.FintechInnovationDirection
...
def test_direction_slug_registered(MODULE_ABBREV):
    ...
    assert "fintech_innovation" in all_dirs
