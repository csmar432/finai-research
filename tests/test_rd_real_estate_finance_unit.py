"""Unit tests for scripts.research_directions.real_estate_finance module."""
...
def MODULE_ABBREV():
    ...
    from scripts.research_directions import real_estate_finance as m
...
def test_module_imports(MODULE_ABBREV):
    ...
    assert hasattr(MODULE_ABBREV, "RealEstateFinanceDirection")
...
def test_direction_class_exists(MODULE_ABBREV):
    cls = MODULE_ABBREV.RealEstateFinanceDirection
...
def test_direction_slug_registered(MODULE_ABBREV):
    ...
    assert "real_estate_finance" in all_dirs
