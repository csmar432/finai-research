"""tests/test_research_esg_finance_deep.py — Deep execution tests for research_directions.esg_finance.
...
try:
    import scripts.research_directions.esg_finance as m
