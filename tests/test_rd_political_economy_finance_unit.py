"""Unit tests for scripts.research_directions.political_economy_finance module."""
...
def MODULE_ABBREV():
    ...
    from scripts.research_directions import political_economy_finance as m
...
def test_module_imports(MODULE_ABBREV):
    ...
    assert hasattr(MODULE_ABBREV, "PoliticalEconomyFinanceDirection")
...
def test_direction_class_exists(MODULE_ABBREV):
    cls = MODULE_ABBREV.PoliticalEconomyFinanceDirection
...
def test_direction_slug_registered(MODULE_ABBREV):
    ...
    assert "political_economy_finance" in all_dirs
