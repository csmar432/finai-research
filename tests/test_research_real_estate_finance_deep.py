"""tests/test_research_real_estate_finance_deep.py — Deep execution tests for research_directions.real_estate_finance.
...
try:
    import scripts.research_directions.real_estate_finance as m
...
class TestValidate:
    def test_validate_empty(self):
        try:
            d = m.RealEstateFinanceDirection()
            r = d.validate({})
