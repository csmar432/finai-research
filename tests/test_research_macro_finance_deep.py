"""tests/test_research_macro_finance_deep.py — Deep execution tests for research_directions.macro_finance.
...
try:
    import scripts.research_directions.macro_finance as m
